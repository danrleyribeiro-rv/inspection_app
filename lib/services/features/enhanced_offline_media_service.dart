...
class EnhancedOfflineMediaService {
  ...
  static EnhancedOfflineMediaService get instance => _instance ??= EnhancedOfflineMediaService._();
  ...
  Future<String> uploadProfileImage(String imagePath, String userId) async {
    try {
      ...
      debugPrint('EnhancedOfflineMediaService: Error uploading profile image: $e');
      rethrow;
    }
  }
  ...
  Future<void> _processImage(String mediaId, String imagePath) async {
    try {
      ...
      if (image != null) {
        ...
        await _mediaRepository.updateDimensions(mediaId, resized.width, resized.height);
        
        debugPrint('EnhancedOfflineMediaService: Image processed successfully: $mediaId');
      }
    } catch (e) {
      debugPrint('EnhancedOfflineMediaService: Error processing image $mediaId: $e');
    }
  }
  ...
  Future<void> _processVideo(String mediaId, String videoPath) async {
    try {
      ...
      debugPrint('EnhancedOfflineMediaService: Video processed successfully: $mediaId');
    } catch (e) {
      debugPrint('EnhancedOfflineMediaService: Error processing video $mediaId: $e');
    }
  }
  ...
  Future<List<OfflineMedia>> getImagesByInspection(String inspectionId) async {
    return await _mediaRepository.findByInspectionIdAndType(inspectionId, 'image');
  }
  
  Future<List<OfflineMedia>> getVideosByInspection(String inspectionId) async {
    return await _mediaRepository.findByInspectionIdAndType(inspectionId, 'video');
  }
  ...
  Future<List<OfflineMedia>> getMediaPaginated(String inspectionId, int page, int pageSize) async {
    final offset = page * pageSize;
    return await _mediaRepository.findByInspectionIdPaginated(inspectionId, pageSize, offset);
  }
  ...
  Future<void> syncMedia() async {
    try {
      ...
      if (await _syncService.isConnected()) {
        ...
        debugPrint('EnhancedOfflineMediaService: No internet connection for sync');
      }
    } catch (e) {
  ...
  Future<void> syncMediaForInspection(String inspectionId) async {
    try {
      debugPrint('EnhancedOfflineMediaService: Starting media sync for inspection $inspectionId');
      ...
      if (await _syncService.isConnected()) {
        ...
        debugPrint('EnhancedOfflineMediaService: Media sync completed for inspection $inspectionId');
      } else {
        debugPrint('EnhancedOfflineMediaService: No internet connection for sync');
      }
    } catch (e) {
      debugPrint('EnhancedOfflineMediaService: Error during media sync for inspection $inspectionId: $e');
    }
  }
  ...
  Future<bool> moveMedia({
    ...
    try {
      ...
      debugPrint('EnhancedOfflineMediaService: Media moved successfully: $mediaId');
      return true;
    } catch (e) {
