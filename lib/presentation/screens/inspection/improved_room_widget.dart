// lib/presentation/screens/inspection/improved_room_widget.dart
import 'package:flutter/material.dart';
import 'package:inspection_app/models/room.dart';
import 'package:inspection_app/models/item.dart';
import 'package:inspection_app/presentation/screens/inspection/improved_item_widget.dart';
import 'package:inspection_app/services/inspection_service.dart';

class ImprovedRoomWidget extends StatefulWidget {
  final Room room;
  ...
  @override
  State<ImprovedRoomWidget> createState() => _ImprovedRoomWidgetState();
}

class _ImprovedRoomWidgetState extends State<ImprovedRoomWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    int filledItems = _items.where((i) => 
        (i.observation != null && i.observation!.isNotEmpty)).length;
    
    double progress = totalItems > 0 ? filledItems / totalItems : 0.0;
    
    // Check if room itself has data filled
    bool isRoomFilled = (widget.room.observation != null && widget.room.observation!.isNotEmpty);
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: isRoomFilled ? Colors.purple.withOpacity(0.1) : Colors.grey.withOpacity(0.1),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (widget.room.roomLabel != null && widget.room.roomLabel!.isNotEmpty)
                    Padding(
                  ...
                  if (_isLoading)
                    ...
                    ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final itemTemplate = (widget.roomTemplate['items'] as List?)?.firstWhere(
                          (t) => t['name'] == item.itemName,
                          orElse: () => {}, // Default to empty if template not found
                        );
                        
                        return ImprovedItemWidget(
                          item: item,
