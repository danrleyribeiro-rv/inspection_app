...
class NonConformityList extends StatelessWidget {
  ...
  Widget _buildNonConformityCard(BuildContext context, Map<String, dynamic> item) {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('${room['room_name'] ?? "N/A"} > ${roomItem['item_name'] ?? "N/A"} > ${detail['detail_name'] ?? "N/A"}'),
            const SizedBox(height: 16),
              ...
              Row(
                ...
                children: [
                  if (item['status'] == 'pendente')
                    ElevatedButton(
                      onPressed: () => onStatusUpdate(item['id'], 'em_andamento'),
