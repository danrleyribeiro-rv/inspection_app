...
class LandscapeView extends StatelessWidget {
  ...
  Widget _buildItemsColumn(BuildContext context) {
    if (selectedRoomIndex < 0) {
      return const Center(child: Text('Select a room', style: TextStyle(color: Colors.white)));
    }
          ...
          child: Row(
            children: [
              ...
              IconButton(
                ...
                onPressed: () async {
                  // Logic to add item
                  if (selectedRoomIndex >= 0 && rooms[selectedRoomIndex].id != null) {
                    final name = await _showTextInputDialog(context, 'Add Item', 'Item name');
  ...
  Widget _buildDetailsColumn(BuildContext context) {
    if (selectedItemIndex < 0) {
      return const Center(child: Text('Select an item', style: TextStyle(color: Colors.white)));
    }
              ...
              IconButton(
                ...
                onPressed: () async {
                  ...
                  if (selectedItemIndex >= 0) {
                    ...
                    if (item.id != null && item.roomId != null) {
                      final name = await _showTextInputDialog(context, 'Add Detail', 'Detail name');
                      if (name != null && name.isNotEmpty) {
