// lib/presentation/screens/inspection/improved_detail_widget.dart
...
class ImprovedDetailWidget extends StatefulWidget {
  final Detail detail;
  ...
  @override
  State<ImprovedDetailWidget> createState() => _ImprovedDetailWidgetState();
}

class _ImprovedDetailWidgetState extends State<ImprovedDetailWidget> {
  ...
  @override
  void didUpdateWidget(ImprovedDetailWidget oldWidget) {
  ...
  Future<void> _showDeleteConfirmation() async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text('Are you sure you want to delete "${widget.detail.detailName}"?'),
        actions: [
          TextButton(
  ...
  Widget build(BuildContext context) {
    ...
    final isFilled = (widget.detail.detailValue != null && widget.detail.detailValue!.isNotEmpty) ||
                       (widget.detail.observation != null && widget.detail.observation!.isNotEmpty);
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: isFilled ? Colors.green.withOpacity(0.1) : Colors.grey.withOpacity(0.1),
