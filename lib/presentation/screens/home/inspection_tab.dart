...
class _InspectionsTabState extends State<InspectionsTab> {
    ...
    try {
      ...
      final inspectorSnapshot = await _firestore
          ...
          .get(const GetOptions(
              source: Source.serverAndCache)); // Try cache first
        ...
        actions: [
          ...
          StreamBuilder<List<ConnectivityResult>>(
            stream: _connectivity.onConnectivityChanged
                .distinct(), // Use distinct to avoid rapid rebuilds
            initialData: _isOnline
                ? [ConnectivityResult.wifi]
                : [ConnectivityResult.none], // Provide initial based on state
            builder: (context, snapshot) {
              ...
              if (snapshot.hasData && snapshot.data!.isNotEmpty) {
                isCurrentlyOnline = snapshot.data!
                    .any((result) => result != ConnectivityResult.none);
              ...
              return Container(
                ...
                decoration: BoxDecoration(
                  color: isCurrentlyOnline
                      ...
                      : Colors.orange.shade700, // Darker shades
          ...
          IconButton(
            ...
            onPressed:
                _isLoading ? null : _loadInspections, // Disable while loading
          ),
        ],
      ),
      body: _isLoading
      ...
      child: Column(
        ...
        children: [
          Icon(Icons.list_alt_outlined,
              size: 64, color: Colors.blueGrey.shade300), // Changed icon
  ...
  Future<void> _navigateToInspectionDetail(String inspectionId) async {
    ...
    final result = await Navigator.of(context).push<bool>(
      // Expect a boolean result (true if data changed)
      MaterialPageRoute(
